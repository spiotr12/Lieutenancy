...
<head>
    ...
    <title>Lord-Lieutenant of Kincardineshire</title>
...
<div class="row logonav">
    ...
    <div class="small-12 medium-9 large-8 columns header">
        <h1>Lord Lieutenancy</h1>
        <h1>Kincardineshire</h1>
        <div class="sticky">
            <nav id="movableTopBar" class="top-bar" data-topbar role="navigation">
                <ul class="title-area">
                    <li class="name hide-for-medium hide-for-large">
                        <!-- Remove this if you don't want a title/logo -->
                        <h1><a href="#">Lord Lieutenancy</a></h1>
                    </li>
